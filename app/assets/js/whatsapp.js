...
// window.WAPI.getChatsModel = function() {
...
// window.WAPI.sendMedia = function(base64Str, base64FileMimeType, chatId, filename, caption, done) {
//   var chat = WAPI.getChat(chatId);

//   var mediaBlob = window.WAPI.base64ToFile(base64Str, filename, base64FileMimeType);
//   var mc = new Store.MediaCollection();
...
//   } else {
//     window.Store.Chat.find(chatId).then(chat => {
//       mc.processFiles([mediaBlob], chat, 1).then(() => {
//         var media = mc.models[0];
//         media.sendToChat(chat, {caption: caption});
//         done(true);
...
// window.WAPI.base64ToFile = function(base64Str, filename, mimeType) {
